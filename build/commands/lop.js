...
module.exports = {
    ...
    execute: function (message, args) {
        return __awaiter(this, void 0, void 0, function () {
            var appendages, user, mentionedUser, index, appendage, tempArr, _i, _a, index_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        for (_i = 0, _a = mentionedUser.appendages; _i < _a.length; _i++) {
                            index_1 = _a[_i];
                        ...
                        mongo_client_1.default.users.updateOne({ id: user.id }, { $set: {
                                appendages: tempArr
                            } }).then(function () {
